...
async def health_check():
    ...
    try:
        ...
        # Check if Gemini API is available
        if orchestration_engine.gemini_manager.is_available():
            health_status["gemini_api"] = "available"
        else:
            health_status["gemini_api"] = "fallback_mode"

        # Check vector stores
        health_status["vector_stores"] = len(orchestration_engine.vector_stores)
